...
module_declaration:
  ...
  'endmodule' ( ':' module_identifier )?  # ModuleNonansi
  | module_ansi_header ( timeunits_declaration )? ( non_port_module_item )*
  'endmodule' ( ':' module_identifier )?  # ModuleAnsi
  | ( attribute_instance )* module_keyword ( lifetime )? module_identifier '(' '.*' ')' ';'
    ( timeunits_declaration )? ( module_item )* 'endmodule' ( ':' module_identifier )?    # ModuleIdent
  | 'extern' module_nonansi_header    # ModuleExtern
  | 'extern' module_ansi_header     # ModuleExtren
  ;
